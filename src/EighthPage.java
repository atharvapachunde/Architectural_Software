...
//Heading Panel Variables
   ...
   public EighthPage(String surveyno, String gatno, String ctsno, String plotno, String village, String taluka, double lowest) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("PROVISION FOR AMENITY SPACE");

        jScrollPane1.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
        jScrollPane1.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);

        jLabel3.setText("<html>The landowner must develop the amenity space for specific public uses such as gardens, playgrounds, schools, <br> hospitals, fire brigades, or housing for displaced persons.</html>");

        jLabel4.setText("<html>This regulation shall not be applicable where separate amenity space is mandated by the Government, while <br> sanctioning modification proposal under section  37 or 20 of the Act.</html");

        jLabel5.setText("<html>If the Authority takes over the amenity space, the landowner gets additional Floor Space Index (FSI) in-situ(on the <br> remaining land) or Transferable Development Rights (TDR).</html>");
        ...
        jLabel6.setText("Enter Total Land Area (in sq.m): ");
...
//        Float tla = Float.valueOf(jTextField1.getText()); 
//    if(tla < 20_000){
