...
//Heading Panel Variables
    ...
    public Page10(String surveyno, String gatno, String ctsno, String plotno, String village, String taluka, double lowest) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Inclusive Housing ");

        jLabel5.setText("a. For the sub-division or layout of the land :-");

        jLabel6.setText("-->For any residential land sub-division of 4000 Sq.m. or more (after deducting specific areas)a minimum of 20% of the plot area must be provided for EWS/LIG housing.");

        jLabel7.setText("-->Plots of 30 to 50 sq.m. for EWS/LIG, allotted as per the list provided by MHADA.");

        jLabel8.setText("-->Plots equivalent to 20% of the area for constructing EWS/LIG tenements to be handed over to MHADA, including proportionate road and recreational open space.");

        jLabel9.setText("-->Developer-Constructed EWS/LIG Tenements where landowner can opt to construct EWS/LIG tenements on this 20% plot area.");

        jLabel10.setText("-->Affordable housing plots/tenements can also be provided at a different location within 1 km of the original site or within the same ward.");

        jLabel11.setText("b.For Group Housing Scheme :-");

        jLabel12.setText("Constructed at least to the extent of 20% of the basic FSI subject to the \n" +
            "following conditions :-  ");

        jLabel14.setText("-->20% under the scheme is exempt from FSI calculations and allowed over and above the permissible FSI/TDR as per UDCPR.");

        jLabel15.setText("-->40% of these tenements may be built within 1 km or the same ward on an alternative plot with FSI exemption");

        jLabel16.setText("developer must inform MHADA, which has six months to provide a list of allottees; tenements will be sold at ASR cost plus 25% (including 1% for MHADA)");

        jLabel17.setText("->if allottees fail to pay or MHADA/Planning Authority fails to provide the list, the developer may sell the tenements to EWS/LIG buyers as per regulations.");

        jLabel18.setText("-->The Land owner must utilise 1/4th of the total 20% FSI.");

        jLabel19.setText("-->Amalgamation of affordable plots / affordable tenements shall not be allowed");

        jLabel20.setText("c.Prospective Applicability :-");

        jLabel21.setText("<html>-->This provision \n" +
            "shall be applicable to revised permission where revised permission is sought including \n" +
            "additional area more than 4000.</html>");
        ...
        jLabel22.setText("Inclusive Housing");
        ...
        jLabel23.setText("Enter Land Area (in sq. m.)");
        ...
        jLabel3.setText("This regulation shall be applicable only to Municipal Corporations having population 10 lacs or more as per the latest Census");

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel2.setText("Provision for Inclusive housing");
    ...
    private void jTextField1FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField1FocusLost
        float area = Float.parseFloat(jTextField1.getText());
        if(area>4000)
        {
            float areatobeprovided=(float)0.2*area;
            jLabel24.setText("Area to be provided: "+areatobeprovided+" sq.m. according to above parameters.");
        }
